...
<div class="m-5 p-2 text-center">
    <div class="p-2">
        ...
        done. Without just doing something similar to the Final Project, as some sort of replication.</p>
    </div>
    <hr>
    <div class="p-2">
    ...
    <div class="p-2">
        ...
        The client doesn't have direct access to the SQL Server, can only GET and POST formulated  queries through the Web Applcation.
    ...
    <div class="p-2">
        ...
        <p>The Database is scrapped from NOAA, ~800 rows, and queried Server-Side in the Web application.
            ...
            lowest latency on a Web Application. Web Application Latency 20-40ms, SQL Server ~200-400ms, Render 150ms</p>
    </div>
</div>
